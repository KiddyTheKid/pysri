...
class Empresa(models.Model):
    ...
    direccion_establecimiento = models.CharField(max_length=250, null=True, blank=True)
    ...
    tipo_ambiente = models.IntegerField(
        choices={
            1: "Produccion",
            2: "Pruebas",
        },
    ...
    tipo_emision = models.IntegerField(
        choices={
            1: "Normal",
        },
        default=1,
    ...
    contribuyente_especial = models.CharField(max_length=250, null=True, blank=True)
    email_notificacion = models.EmailField(max_length=60, null=True, blank=True)
